...
export default function ChargingPage() {
  ...
  const calculateChargingCost = () => {
    ...
    const estimatedRange = Math.round(energyToAdd * 3.7 * 0.621371); // 3.7 mile/kWh
    const acChargingHours = energyToAdd / 11;
    const dcChargingHours = energyToAdd / 50;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#660566] via-[#330233] to-black mb-4">
              Charging Station Fees
            </h1>
            <p className="text-lg text-gray-600">
              View current charging station rates and calculate your charging cost.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              {/* RIGHT: Şarj Maliyeti Hesaplayıcı */}
                  ...
                  {calculationResult && (
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      ...
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-lg font-semibold text-gray-900">{calculationResult.acChargingTime}</span>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm text-gray-600">DC Charging Time (50 kW)</span>
                        <span className="text-lg font-semibold text-gray-900">{calculationResult.dcChargingTime}</span>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm text-gray-600">Supercharger Time (250 kW)</span>
                        <span className="text-lg font-semibold text-gray-900">{calculationResult.superChargerTime}</span>
                      </div>
                    </div>
                  )}
                </div>
