          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <div className="text-center space-y-8">
              ...
              <div>
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">E-posta</h2>
                <a href="mailto:info@elektrikliyiz.com" className="text-[#660566] hover:text-[#330233] transition-colors">
                  info@elektrikliyiz.com
                </a>
              </div>
