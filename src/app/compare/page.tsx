            ...
            <div ref={(el) => { dropdownRefs.current[index] = el; }} className="relative w-full overflow-visible">
              ...
              >
                ...
                <button
                  ...
                  tabIndex={-1}
                  aria-label="Open/close search menu"
                >
                  <svg
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h4 className="font-medium text-gray-900">
                      {selectedVehicles[index]?.brand} {selectedVehicles[index] ? customNames[selectedVehicles[index].id] || selectedVehicles[index]?.model : ''}
                    </h4>
                  </div>
                  <button
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="space-y-6">
              {[
                ...
                { key: 'price.base', label: 'Starting Price', unit: '' },
              ].map(({ key, label, unit }) => (
                <div key={key} className="grid grid-cols-4 gap-4 py-4 border-t border-gray-100">
                  ...
                  {selectedVehicles.map((vehicle, index) => {
                    ...
                    if (key == "price.base" && vehicle) {
                      ...
                      value = typeof customPrice === 'number'
              ...
              <button
                onClick={() => {
                  ...
                  try {
                    ...
                    // Kullanıcıya bildir
                    alert('Comparison saved! You can view it in the "My Comparisons" tab on your profile page.');
                  } catch (error) {
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 relative">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-6">
              With premium membership, you can compare 3 vehicles at the same time and perform detailed analyses.
            </p>
